<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold text-slate-900">Create Room</h1>
        </div>
    </x-slot>
            ...
            <form action="{{ route('rooms.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="room_number" id="room_number" class="form-input" value="{{ old('room_number') }}" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="floor" id="floor" class="form-input" value="{{ old('floor') }}" required>
